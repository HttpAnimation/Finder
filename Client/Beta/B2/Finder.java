...
public class Finder {
    ...
    public static void main(String[] args) {
        try {
            ...
            JsonArray reposArray = Json.createReader(new java.io.StringReader(reposJson)).readArray();
            ...
            for (int i = 0; i < reposArray.size(); i++) {
                ...
                JsonObject repoDataObject = Json.createReader(new java.io.StringReader(repoData)).readObject();
